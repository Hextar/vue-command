...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"3f8d0e6a-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/VueCommand.vue?vue&type=template&id=2271a0ea&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"vue-command",staticClass:"vue-command"},[_vm._t("bar",[(!_vm.hideBar)?_c('div',{staticClass:"term-bar"},[(!_vm.hideTitle)?_c('span',{staticClass:"term-title"},[_vm._v(" "+_vm._s(_vm.title)+" ")]):_vm._e()]):_vm._e()]),_c('div',{ref:"term-std",staticClass:"term-std"},[(_vm.isSearch)?_c('search',{ref:"search",attrs:{"executed":_vm.local.executed,"is-search":_vm.isSearch,"stdin":_vm.stdin},on:{"update:isSearch":function($event){_vm.isSearch=$event},"update:is-search":function($event){_vm.isSearch=$event},"click":_vm.focus,"handle":_vm.handle}}):_vm._e(),_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.isSearch),expression:"!isSearch"}],ref:"term-cont",staticClass:"term-cont",class:{ 'term-cont-fullscreen': _vm.local.isFullscreen },on:{"click":_vm.focus}},[(_vm.showIntro)?_c('div',[_vm._v(" "+_vm._s(_vm.intro)+" ")]):_vm._e(),_vm._l((_vm.local.history),function(stdout,index){return _c('div',{key:index,staticClass:"term-hist",class:{ 'term-hist-fullscreen' : (_vm.local.isFullscreen && index === _vm.local.history.length - 1) }},[_c('stdout',{directives:[{name:"show",rawName:"v-show",value:((!_vm.local.isFullscreen || index === _vm.local.history.length - 1)),expression:"(!local.isFullscreen || index === local.history.length - 1)"}],staticClass:"term-stdout",attrs:{"component":stdout}}),_c('stdin',{directives:[{name:"show",rawName:"v-show",value:(stdout.includePromptAfter && ((index === 0 && !_vm.local.isFullscreen) || !(index === _vm.local.history.length - 1 && _vm.local.isInProgress) && !_vm.local.isFullscreen)),expression:"stdout.includePromptAfter && ((index === 0 && !local.isFullscreen) || !(index === local.history.length - 1 && local.isInProgress) && !local.isFullscreen)"}],ref:"stdin",refInFor:true,attrs:{"bus":_vm.bus,"cursor":_vm.local.cursor,"hide-prompt":_vm.hidePrompt,"is-fullscreen":_vm.local.isFullscreen,"is-in-progress":_vm.local.isInProgress,"is-last":index === _vm.local.history.length - 1,"prompt":_vm.prompt,"help-text":_vm.helpText,"help-timeout":_vm.helpTimeout,"show-help":_vm.showHelp,"stdin":_vm.local.stdin,"uid":_vm._uid},on:{"update:stdin":function($event){return _vm.$set(_vm.local, "stdin", $event)},"handle":_vm.handle},scopedSlots:_vm._u([{key:"prompt",fn:function(){return [_vm._t("prompt")]},proxy:true}],null,true)})],1)})],2)],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/VueCommand.vue?vue&type=template&id=2271a0ea&
...
var library_createStdout = function createStdout(content) {
  ...
  var includePromptAfter = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  var isEscapeHtml = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  var name = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'VueCommandStdout';

  for (var _len = arguments.length, mixins = new Array(_len > 5 ? _len - 5 : 0), _key = 5; _key < _len; _key++) {
    mixins[_key - 5] = arguments[_key];
  }
